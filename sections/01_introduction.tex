...
%
\added{Despite the resulting data-agnostic alignment via Automated Planning is semantically equivalent to customary cost-based aligners \cite{DBLP:conf/edoc/AdriansyahDA11}, our previous works \cite{XuLZ17a,LeoniM17} showed that the former outperforms the latter in terms of computational performance and scalability in presence of traces and models of considerable size, which is the case of this paper. In fact, as a consequence of the reduction of data-aware alignment into a data-agnostic one, the automata-based process models used as input for our approach have several more edges and states than in traditional alignment problems. To this aim, as we needed to show the feasibility of our approach, we decided to resort to planning-base alignment for both presenting our framework outline and performing the experiments.}
%
