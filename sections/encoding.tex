...
%
To capture the structure of the automaton and to monitor its evolution, we defined four \emph{domain propositions} as boolean predicates in $\mathcal{P_D}$:
%
\begin{itemize}
...
%
Finally, \PDDL{ins} is performed only for transitions involving activity \PDDL{e} connecting two states of the constraint automaton, with the current state of the trace automaton that remains the same after the execution of the action.
%
